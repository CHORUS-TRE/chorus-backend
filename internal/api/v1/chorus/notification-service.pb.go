...
type GetNotificationsRequest struct {
	...
	IsRead     *wrapperspb.BoolValue `protobuf:"bytes,2,opt,name=isRead,proto3" json:"isRead,omitempty"`
}
...
func (x *GetNotificationsRequest) GetIsRead() *wrapperspb.BoolValue {
	if x != nil {
		return x.IsRead
	}
	return nil
...
type NotificationServiceClient interface {
	CountUnreadNotifications(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CountUnreadNotificationsReply, error)
	MarkNotificationsAsRead(ctx context.Context, in *MarkNotificationsAsReadRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *notificationServiceClient) CountUnreadNotifications(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CountUnreadNotificationsReply, error) {
...
func (c *notificationServiceClient) MarkNotificationsAsRead(ctx context.Context, in *MarkNotificationsAsReadRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type NotificationServiceServer interface {
	CountUnreadNotifications(context.Context, *emptypb.Empty) (*CountUnreadNotificationsReply, error)
	MarkNotificationsAsRead(context.Context, *MarkNotificationsAsReadRequest) (*emptypb.Empty, error)
...
func (*UnimplementedNotificationServiceServer) CountUnreadNotifications(context.Context, *emptypb.Empty) (*CountUnreadNotificationsReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CountUnreadNotifications not implemented")
}
func (*UnimplementedNotificationServiceServer) MarkNotificationsAsRead(context.Context, *MarkNotificationsAsReadRequest) (*emptypb.Empty, error) {
...
func _NotificationService_CountUnreadNotifications_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).CountUnreadNotifications(ctx, req.(*emptypb.Empty))
	}
