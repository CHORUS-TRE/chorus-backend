...
// NewHTTPClient creates a new chorus dev store service HTTP client.
func NewHTTPClient(formats strfmt.Registry) *ChorusDevStoreService {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new chorus dev store service HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *ChorusDevStoreService {
...
// New creates a new chorus dev store service client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *ChorusDevStoreService {
	// ensure nullable parameters have default
	if formats == nil {
