...
// ChorusListWorkspacesReply chorus list workspaces reply
//
...
func (m *ChorusListWorkspacesReply) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ChorusListWorkspacesReply) UnmarshalBinary(b []byte) error {
	var res ChorusListWorkspacesReply
