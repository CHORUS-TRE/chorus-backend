...
// NewHTTPClient creates a new chorus workspace file service HTTP client.
func NewHTTPClient(formats strfmt.Registry) *ChorusWorkspaceFileService {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new chorus workspace file service HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *ChorusWorkspaceFileService {
...
// New creates a new chorus workspace file service client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *ChorusWorkspaceFileService {
	// ensure nullable parameters have default
	if formats == nil {
