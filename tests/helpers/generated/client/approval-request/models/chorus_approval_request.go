...
func (m *ChorusApprovalRequest) validateFiles(formats strfmt.Registry) error {
...
func (m *ChorusApprovalRequest) contextValidateFiles(ctx context.Context, formats strfmt.Registry) error {
