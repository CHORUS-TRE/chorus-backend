...
// WithFilterWorkspaceIdsIn adds the filterWorkspaceIdsIn to the workbench service list workbenches params
func (o *WorkbenchServiceListWorkbenchesParams) WithFilterWorkspaceIdsIn(filterWorkspaceIdsIn []string) *WorkbenchServiceListWorkbenchesParams {
	o.SetFilterWorkspaceIdsIn(filterWorkspaceIdsIn)
	return o
}

// SetFilterWorkspaceIdsIn adds the filterWorkspaceIdsIn to the workbench service list workbenches params
func (o *WorkbenchServiceListWorkbenchesParams) SetFilterWorkspaceIdsIn(filterWorkspaceIdsIn []string) {
...
// bindParamWorkbenchServiceListWorkbenches binds the parameter filter.workspaceIdsIn
func (o *WorkbenchServiceListWorkbenchesParams) bindParamFilterWorkspaceIdsIn(formats strfmt.Registry) []string {
