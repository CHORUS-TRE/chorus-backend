...
// ChorusNotification chorus notification
//
...
func (m *ChorusNotification) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *ChorusNotification) validateReadAt(formats strfmt.Registry) error {
...
func (m *ChorusNotification) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ChorusNotification) UnmarshalBinary(b []byte) error {
	var res ChorusNotification
